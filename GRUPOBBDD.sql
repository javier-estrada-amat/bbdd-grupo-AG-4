...
ADD CONSTRAINT FK_EMPLOYEE_JOB_HISTORY_EMPLOYEE_ID FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEES(EMPLOYEE_ID);
ALTER TABLE EMPLOYEE_JOB_HISTORY
ADD CONSTRAINT FK_EMPLOYEE_JOB_HISTORY_DEPARTMENT_ID FOREIGN KEY (DEPARTMENT_ID) REFERENCES DEPARTMENTS(DEPARTMENT_ID);
ALTER TABLE EMPLOYEE_JOB_HISTORY
ADD CONSTRAINT FK_EMPLOYEE_JOB_HISTORY_JOB_ID FOREIGN KEY (JOB_ID) REFERENCES JOBS(JOB_ID);
...
(101, 'Juan', 'García', 'juan.garcia@example.com', '666222333', '2020-01-01', 60000.00, NULL, NULL, 1, 1);
INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_, HIRE_DATE, SALARY, COMMISSION_PCT, MANAGER_ID, JOB_ID, DEPARTMENT_ID) VALUES
(102, 'María', 'Rodríguez', 'maria.rodriguez@example.com', '666222331', '2020-02-01', 70000.00, NULL, NULL, 2, 2);
INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_, HIRE_DATE, SALARY, COMMISSION_PCT, MANAGER_ID, JOB_ID, DEPARTMENT_ID) VALUES
(103, 'Pablo', 'Martínez', 'pablo.martinez@example.com', '666222332', '2020-03-01', 80000.00, NULL, NULL, 3, 3);
INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_, HIRE_DATE, SALARY, COMMISSION_PCT, MANAGER_ID, JOB_ID, DEPARTMENT_ID) VALUES
(104, 'Ana', 'Fernández', 'ana.fernandez@example.com', '666222334', '2020-04-01', 90000.00, NULL, NULL, 4, 4);
INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_, HIRE_DATE, SALARY, COMMISSION_PCT, MANAGER_ID, JOB_ID, DEPARTMENT_ID) VALUES
(105, 'David', 'López', 'david.lopez@example.com', '666222335', '2020-05-01', 100000.00, NULL, NULL, 5, 5);
...
(101, 1, 1, '2020-01-01', NULL);
INSERT INTO EMPLOYEE_JOB_HISTORY (EMPLOYEE_ID, DEPARTMENT_ID, JOB_ID, START_DATE, END_DATE) VALUES
(102, 2, 2, '2020-02-01', NULL);
INSERT INTO EMPLOYEE_JOB_HISTORY (EMPLOYEE_ID, DEPARTMENT_ID, JOB_ID, START_DATE, END_DATE) VALUES
(103, 3, 3, '2020-03-01', NULL);
INSERT INTO EMPLOYEE_JOB_HISTORY (EMPLOYEE_ID, DEPARTMENT_ID, JOB_ID, START_DATE, END_DATE) VALUES
(104, 4, 4, '2020-04-01', NULL);
INSERT INTO EMPLOYEE_JOB_HISTORY (EMPLOYEE_ID, DEPARTMENT_ID, JOB_ID, START_DATE, END_DATE) VALUES
(105, 5, 5, '2020-05-01', NULL);
